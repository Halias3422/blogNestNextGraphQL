...
describe('UserService', () => {
	...
	describe('createNewUser', () => {
		...
		it('should have returned userOutput if new user created', async () => {
			...
			expect(await userService.createNewUser(userInput)).toEqual(
				userOutput
			);
		});

		it('should have returned empty UserOutput if new user not created', async () => {
			jest.spyOn(userService, 'findOneUserByLogin').mockReturnValueOnce(
				Promise.resolve(userOutput)
			);
			expect(await userService.createNewUser(userInput)).toEqual(
